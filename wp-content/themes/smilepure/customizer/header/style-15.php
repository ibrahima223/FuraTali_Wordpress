...
Smilepure_Kirki::add_field( 'theme', array(
	'type'     => 'radio-buttonset',
	'settings' => $prefix . 'header_top_enable',
	'label'    => esc_html__( 'Header top', 'smilepure' ),
	'section'  => $section,
	'priority' => $priority ++,
	'default'  => '1',
	'choices'  => array(
...
Smilepure_Kirki::add_field( 'theme', array(
	...
	'label'       => esc_html__( 'Header Top border Color', 'smilepure' ),
	'description' => esc_html__( 'Controls the border color of header top', 'smilepure' ),
	'section'     => $section,
	'priority'    => $priority ++,
	'transport'   => 'auto',
...
Smilepure_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
			'element'  => '.header-15 .header-link-list .link-item, .header-15 .header-top-text',
			'property' => 'font-size',
			'units'    => 'px',
		),
	),
...
Smilepure_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
			...
			.header-15 .header-link-list .link-item,
			.header-15 .header-link-list .link-item a',
			'property' => 'color',
		),
	),
) );
...
Smilepure_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
			'element'  => '.header-15 .header-link-list .link-item a:hover',
			'property' => 'color',
		),
	),
) );
...
Smilepure_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
			...
			.header-15 .header-link-list .link-item i',
			'property' => 'color',
		),
	),
) );
...
Smilepure_Kirki::add_field( 'theme', array(
	...
	'label'       => esc_html__( 'Bottom Border Color', 'smilepure' ),
	'description' => esc_html__( 'Controls the border bottom color for main menu items.', 'smilepure' ),
	'section'     => $section,
	'priority'    => $priority ++,
	'transport'   => 'auto',
	'default'     => Smilepure::PRIMARY_COLOR,
...
Smilepure_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
			'choice'   => 'color',
			'element'  => '.header-15 .header-button .tm-button',
			'property' => 'color',
		),
		array(
			'choice'   => 'border',
...
Smilepure_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
			'choice'   => 'color',
			'element'  => '.header-15 .header-button .tm-button:hover',
			'property' => 'color',
		),
		array(
			'choice'   => 'border',
