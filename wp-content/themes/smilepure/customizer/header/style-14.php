...
Smilepure_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
			'element'  => '.header-14 .header-info .info-icon',
			'property' => 'color',
		),
	),
) );
...
Smilepure_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
			'element'  => '.header-14 .header-info .info-title',
			'property' => 'color',
		),
	),
) );
...
Smilepure_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
			'element'  => '.header-14 .header-info .info-sub-title',
			'property' => 'color',
		),
	),
) );
...
Smilepure_Kirki::add_field( 'theme', array(
	...
	'output'          => array(
		array(
			'element'  => '.header-14 .header-below',
			'property' => 'background-color',
		),
	),
	'active_callback' => array(
...
Smilepure_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
			'element' => '.desktop-menu .header-14 .sm-simple > li > a',
		),
	),
) );
...
Smilepure_Kirki::add_field( 'theme', array(
	...
	'output'          => array(
		array(
			'element'  => '.desktop-menu .header-14.headroom--not-top .header-below',
			'property' => 'background-color',
		),
	),
	'active_callback' => array(
