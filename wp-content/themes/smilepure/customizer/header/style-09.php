...
Smilepure_Kirki::add_field( 'theme', array(
	...
	'section'  => $section,
	'priority' => $priority ++,
	'default'  => esc_html__( 'Purchase Now', 'smilepure' ),
) );
...
Smilepure_Kirki::add_field( 'theme', array(
	...
	'section'  => $section,
	'priority' => $priority ++,
	'default'  => 'https://themeforest.net/user/thememove/portfolio',
) );
...
Smilepure_Kirki::add_field( 'theme', array(
	...
	'default'     => array(
		'color'      => '#fff',
		'background' => Smilepure::HEADING_COLOR,
		'border'     => Smilepure::HEADING_COLOR,
	),
	'output'      => array(
		array(
			'choice'   => 'color',
