...
Smilepure_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
			'element'  => '.header-21 .branding__logo img',
			'property' => 'padding',
		),
	),
) );
...
Smilepure_Kirki::add_field( 'theme', array(
	...
	'section'  => $section,
	'priority' => $priority ++,
	'default'  => '<div class="big_title">' . esc_html__( 'Info text Left', 'smilepure' ) . '</div>',
) );

Smilepure_Kirki::add_field( 'theme', array(
	'type'     => 'text',
	'settings' => $prefix . 'info_text_left',
	'label'    => esc_html__( 'Info Text Left', 'smilepure' ),
	'section'  => $section,
	'priority' => $priority ++,
	'default'  => esc_html__( 'Service Available', 'smilepure' ),
) );

Smilepure_Kirki::add_field( 'theme', array(
	'type'     => 'text',
	'settings' => $prefix . 'info_icon_left',
	'label'    => esc_html__( 'Info Left Icon Class', 'smilepure' ),
	'section'  => $section,
	'priority' => $priority ++,
...
Smilepure_Kirki::add_field( 'theme', array(
	'type'     => 'text',
	'settings' => $prefix . 'info_sub_text_left',
	'label'    => esc_html__( 'Info Sub Text Left', 'smilepure' ),
	'section'  => $section,
	'priority' => $priority ++,
...
Smilepure_Kirki::add_field( 'theme', array(
	'type'     => 'text',
	'settings' => $prefix . 'info_link_text_left',
	'label'    => esc_html__( 'Info Left Link', 'smilepure' ),
	'section'  => $section,
	'priority' => $priority ++,
	'default'  => 'tel:0088866688',
) );
...
Smilepure_Kirki::add_field( 'theme', array(
	...
	'section'  => $section,
	'priority' => $priority ++,
	'default'  => '<div class="big_title">' . esc_html__( 'Info text Right', 'smilepure' ) . '</div>',
) );

Smilepure_Kirki::add_field( 'theme', array(
	'type'     => 'text',
	'settings' => $prefix . 'info_text_right',
	'label'    => esc_html__( 'Info Text Right', 'smilepure' ),
	'section'  => $section,
	'priority' => $priority ++,
	'default'  => esc_html__( 'Our Brochure', 'smilepure' ),
) );

Smilepure_Kirki::add_field( 'theme', array(
	'type'     => 'text',
	'settings' => $prefix . 'info_icon_right',
	'label'    => esc_html__( 'Info Right Icon Class', 'smilepure' ),
	'section'  => $section,
	'priority' => $priority ++,
	'default'  => 'fal fa-tooth',
) );

Smilepure_Kirki::add_field( 'theme', array(
	'type'     => 'text',
	'settings' => $prefix . 'info_sub_text_right',
	'label'    => esc_html__( 'Info Sub Text Right', 'smilepure' ),
	'section'  => $section,
	'priority' => $priority ++,
	'default'  => esc_html__( 'Download Now', 'smilepure' ),
) );

Smilepure_Kirki::add_field( 'theme', array(
	'type'     => 'text',
	'settings' => $prefix . 'info_link_text_right',
	'label'    => esc_html__( 'Info Right Link', 'smilepure' ),
	'section'  => $section,
	'priority' => $priority ++,
	'default'  => '#',
) );
...
Smilepure_Kirki::add_field( 'theme', array(
	'type'      => 'color-alpha',
	'settings'  => $prefix . 'header_info_icon_bg_color',
	'label'     => esc_html__( 'Info Icon Background Color', 'smilepure' ),
	'section'   => $section,
	'priority'  => $priority ++,
	'transport' => 'auto',
	'default'   => 'rgba(60,189,203,0.12)',
	'output'    => array(
		array(
			'element'  => '
			.header-21 .header-info .info-icon
...
Smilepure_Kirki::add_field( 'theme', array(
	...
	'output'    => array(
		array(
			'element'  => array(
				'.desktop-menu .headroom--not-top.header-21 .menu--primary .menu__container > li > a',
			),
			'property' => 'padding',
		),
	),
...
Smilepure_Kirki::add_field( 'theme', array(
	...
	'output'    => array(
		array(
			'element'  => array(
				'.desktop-menu .headroom--not-top.header-21 .menu--primary .menu__container > li',
			),
			'property' => 'margin',
		),
	),
