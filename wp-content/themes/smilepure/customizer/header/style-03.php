...
Smilepure_Kirki::add_field( 'theme', array(
	...
	'section'  => $section,
	'priority' => $priority ++,
	'default'  => esc_html__( 'Get Appointment', 'smilepure' ),
) );
...
Smilepure_Kirki::add_field( 'theme', array(
	...
	'section'  => $section,
	'priority' => $priority ++,
	'default'  => esc_attr__( 'far fa-calendar-alt', 'smilepure' ),
) );
...
Smilepure_Kirki::add_field( 'theme', array(
	...
	'section'  => $section,
	'priority' => $priority ++,
	'default'  => 'https://smilepure.thememove.com/book-appointment-1/',
) );
...
Smilepure_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
			'choice'   => 'color',
			'element'  => '.header-03 .tm-button:hover',
			'property' => 'color',
		),
		array(
			'choice'   => 'background',
			'element'  => '.header-03 .tm-button:after',
			'property' => 'background-color',
		),
	),
) );
