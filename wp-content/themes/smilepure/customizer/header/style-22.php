<?php
$section  = 'header_style_22';
$priority = 1;
$prefix   = 'header_style_22_';
...
Smilepure_Kirki::add_field( 'theme', array(
	...
	'output'    => array(
		array(
			'element'  => '.header-22 .page-navigation',
...
Smilepure_Kirki::add_field( 'theme', array(
	...
	'output'    => array(
		array(
			'element'  => '.header-22 .page-header-inner',
...
Smilepure_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
			'element'  => '.header-22 .mini-cart .mini-cart-icon:after',
...
Smilepure_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
			'choice'   => 'color',
			'element'  => '.header-22 .tm-button:hover',
			'property' => 'color',
		),
		array(
			'choice'   => 'border',
...
Smilepure_Kirki::add_field( 'theme', array(
	'type'      => 'spacing',
	'settings'  => $prefix . 'navigation_padding',
	'label'     => esc_html__( 'Menu Padding', 'smilepure' ),
	'section'   => $section,
	'priority'  => $priority ++,
	'transport' => 'auto',
	'default'   => array(
...
Smilepure_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
			'element' => '.header-22 .menu--primary a',
		),
	),
) );
...
Smilepure_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
			'element'  => '.header-22 .menu--primary .menu__container > li > a',
			'property' => 'background-color',
		),
	),
) );
...
Smilepure_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
            ...
            .header-22 .menu--primary .menu__container > li.current-menu-item > a',
			'property' => 'background-color',
		),
	),
) );
