...
vc_map( array(
	'name'     => esc_html__( 'Blog', 'smilepure' ),
	'base'     => 'tm_blog',
	'category' => SMILEPURE_VC_SHORTCODE_CATEGORY,
	'icon'     => 'insight-i insight-i-blog',
	'params'   => array_merge( array(
		array(
			'heading'     => esc_html__( 'Blog Style', 'smilepure' ),
			'type'        => 'dropdown',
			'param_name'  => 'style',
			'admin_label' => true,
			'value'       => array(
				esc_html__( 'List Large Image', 'smilepure' )   => 'list',
				esc_html__( 'List Simple', 'smilepure' )        => 'list_simple',
				esc_html__( 'List Simple 02', 'smilepure' )     => 'list_simple_02',
				esc_html__( 'Grid Classic 01', 'smilepure' )    => 'grid_classic_01',
				esc_html__( 'Grid Classic 02', 'smilepure' )    => 'grid_classic_02',
				esc_html__( 'Grid Classic 03', 'smilepure' )    => 'grid_classic_03',
				esc_html__( 'Grid Metro', 'smilepure' )         => 'metro',
				esc_html__( 'Carousel Slider 01', 'smilepure' ) => 'carousel_01',
				esc_html__( 'Carousel Slider 02', 'smilepure' ) => 'carousel_02',
				esc_html__( 'Carousel Slider 03', 'smilepure' ) => 'carousel_03',
			),
			'std'         => 'list',
		),
		array(
		...
		array(
			'heading'     => esc_html__( 'Row Gutter', 'smilepure' ),
			'description' => esc_html__( 'Controls the gutter of row. Default 30px', 'smilepure' ),
			'type'        => 'number',
