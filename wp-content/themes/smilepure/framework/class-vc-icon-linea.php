...
if ( ! class_exists( 'Smilepure_VC_Icon_Linea' ) ) {
	class Smilepure_VC_Icon_Linea {
		...
		public function add_to_libraries( $list ) {
			$list = $list + array( esc_html__( 'Linea', 'smilepure' ) => 'linea' );
		...
		function admin_enqueue_scripts() {
			...
			wp_enqueue_style( 'font-linea', SMILEPURE_THEME_URI . '/assets/fonts/linea/font-linea.min.css', null, null );
		}

		public function add_fonts( $icons ) {
			$new_icons = array(
				esc_html__( 'Arrows & Direction', 'smilepure' ) => array(
				...
				esc_html__( 'Basic', 'smilepure' )              => array(
				...
				esc_html__( 'Basic Elaboration', 'smilepure' )  => array(
				...
				esc_html__( 'Ecommerce', 'smilepure' )          => array(
				...
				esc_html__( 'Music', 'smilepure' )              => array(
				...
				esc_html__( 'Software', 'smilepure' )           => array(
				...
				esc_html__( 'Weather', 'smilepure' )            => array(
