...
if ( ! class_exists( 'Smilepure_VC_Icon_Ion' ) ) {
	class Smilepure_VC_Icon_Ion {
		...
		public function add_to_libraries( $list ) {
			$list = $list + array( esc_html__( 'Ion', 'smilepure' ) => 'ion' );
		...
		function admin_enqueue_scripts() {
			wp_enqueue_style( 'font-ion', SMILEPURE_THEME_URI . '/assets/fonts/ion/font-ion.min.css', null, null );
		}
