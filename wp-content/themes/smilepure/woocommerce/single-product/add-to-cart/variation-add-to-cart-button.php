...
<div class="woocommerce-variation-add-to-cart variations_button">
	<div class="quantity-button-wrapper">
		<label><?php esc_html_e( 'Quantity', 'smilepure' ); ?></label>
		<?php
	...
	<div class="product-actions">
		...
		<?php Smilepure_Woo::get_wishlist_button_template( array( 'tooltip_position' => 'top' ) ); ?>

		<?php Smilepure_Woo::get_compare_button_template( array( 'tooltip_position' => 'top' ) ); ?>
