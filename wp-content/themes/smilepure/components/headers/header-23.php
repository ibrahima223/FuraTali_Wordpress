					...
					<div class="header-wrap">
						...
						<div class="header-right">
							...
							<div id="header-right-inner" class="header-right-inner">
								<?php
								$info_icon     = Smilepure::setting( 'header_style_23_info_icon' );
								$info_text     = Smilepure::setting( 'header_style_23_info_text' );
								$info_sub_text = Smilepure::setting( 'header_style_23_info_sub_text' );
								?>
